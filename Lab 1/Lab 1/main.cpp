...
int main(int argc, const char * argv[]) {
    ...
    ofstream outFile ("testOut.txt"); //Passes to comply with constructor, but not being used during pasoff. Only used during testing and development.
    Lexer lexer("test.txt", outFile);
